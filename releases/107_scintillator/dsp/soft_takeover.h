...
// releases/97_alloy/dsp/soft_takeover.h, by way of
// releases/106_uncertainty — same problem (a knob doing two jobs
// depending on a switch position), same fix. The mechanism is unchanged;
// only that version's unused waiting() accessor is left out.
//
...
#ifndef SCINTILLATOR_DSP_SOFT_TAKEOVER_H_
#define SCINTILLATOR_DSP_SOFT_TAKEOVER_H_
...
#endif // SCINTILLATOR_DSP_SOFT_TAKEOVER_H_
