...
#if WS_COMPUTER
    {
        // analog panel control: applied after the demo-resolution
        // rounding above so knob/CV movements keep full precision
        extern void ws_adjust_ticcmd(ticcmd_t *cmd);
        ws_adjust_ticcmd(cmd);
    }
#endif
#if DOOM_TINY
    cmd->ingame = true;
