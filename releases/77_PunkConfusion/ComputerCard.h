...
void __not_in_flash_func(ComputerCard::BufferFull)()
{
	...
	// Stop ADC before touching AINSEL; this guarantees any in-progress
	// conversion finishes and lands in the FIFO before we drain it, so DMA
	// re-arm always starts on ch0 with an empty FIFO.
